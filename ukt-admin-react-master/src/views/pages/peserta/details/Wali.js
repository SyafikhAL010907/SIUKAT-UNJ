                            ...
                            <FormGroup row>
                                ...
                                <Col md={4}>
                                    ...
                                    { props.initialValues.scan_wali && (
                                        <Link to={storage+"/"+props.initialValues.no_peserta+"/"+props.initialValues.scan_wali} target="_blank" className="btn btn-success btn-block btn-sm"><i className="fa fa-file"></i> Lihat Surat Komitmen Wali</Link>
                                    )}
                                </Col>
                            </FormGroup>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    { this.props.wali.scan_wali && (
                                        <Link to={ storage+"/"+this.props.wali.no_peserta+"/"+this.props.wali.scan_wali } target="_blank">
                                            <Button color="primary" size="sm"><i className="fa fa-download"></i> Lihat Surat Komitmen Pembiayaan Pendukung</Button>
                                        </Link>
                                    )}
                                    </td>
                                </tr>
