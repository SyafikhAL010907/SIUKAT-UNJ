                        ...
                        <div>
                            ...
                            <FormGroup row>
                                ...
                                { props.initialValues.scan_motor && (
                                    <Col md={4}>
                                        <Link to={storage+"/"+props.initialValues.no_peserta+"/"+props.initialValues.scan_motor} target="_blank" className="btn btn-success btn-block"><i className="fa fa-file"></i> Lihat STNK Motor</Link>
                                    </Col>
                                )}
                            </FormGroup>
                        </div>
                        ...
                        <div>
                            ...
                            <FormGroup row>
                                ...
                                { props.initialValues.scan_mobil && (
                                    <Col md={4}>
                                        <Link to={storage+"/"+props.initialValues.no_peserta+"/"+props.initialValues.scan_mobil} target="_blank" className="btn btn-success btn-block"><i className="fa fa-file"></i> Lihat STNK Mobil</Link>
                                    </Col>
                                )}
                            </FormGroup>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            { this.props.kendaraan.scan_motor && (
                                                <Link to={ storage+"/"+this.props.kendaraan.no_peserta+"/"+this.props.kendaraan.scan_motor } target="_blank">
                                    ...
                                    <tbody>                        
                                        ...
                                        <tr>
                                            ...
                                            { this.props.kendaraan.scan_mobil && (                                        
                                                <Link to={ storage+"/"+this.props.kendaraan.no_peserta+"/"+this.props.kendaraan.scan_mobil } target="_blank">
