            ...
            className={'modal-success'}>
                ...
                <ModalBody>
                    ...
                    <FormGroup row>
                        ...
                        { scan_listrik && (
                            <Col md={4}>
                                <Link to={storage+"/"+props.initialValues.no_peserta+"/"+scan_listrik} target="_blank" className="btn btn-success btn-block"><i className="fa fa-file"></i> Lihat Bukti Tagihan Listrik</Link>
                            </Col>
                        )}
                    </FormGroup>
                </ModalBody>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                { this.props.listrik.scan_listrik && (
                                    <Link to={ storage+"/"+this.props.listrik.no_peserta+"/"+this.props.listrik.scan_listrik } target="_blank">
