...
Ibu.belongsTo(Provinsi, {
  foreignKey: 'provinsi_ibu'
})

Ibu.belongsTo(Kabkot, {
  foreignKey: 'kabkot_ibu'
})

Ibu.belongsTo(Kecamatan, {
  foreignKey: 'kecamatan_ibu'
})

Ibu.belongsTo(Pekerjaan, {
