...
let apiBase =
  process.env.REACT_APP_API_URL || "http://10.255.1.149:8080/api/v1/";
...
const getToken = () => {
  ...
  return cookieToken === "undefined" || cookieToken === "null"
    ? undefined
    : cookieToken;
};
