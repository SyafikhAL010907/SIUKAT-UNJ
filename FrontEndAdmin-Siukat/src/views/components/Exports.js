...
class Exports extends Component {
  ...
  handleExport(e, perPage, to = 1, key = "") {
    ...
    this.props.dispatch(
      cmahasiswa.fetchCmahasiswa(cookies.get(cookieName), {
      ...
      <div className="block sm:inline-block">
        <Button
          className={
            ...
            "btn btn-sm btn-info text-white margin-left-10 margin-top-10"
          }
          onClick={(e) => {
            this.handleExport(e, this.props.count);
          }}
