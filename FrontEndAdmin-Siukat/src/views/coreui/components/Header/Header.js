      ...
      <header className="sticky top-0 z-40 w-full border-b border-gray-100 bg-white/80 backdrop-blur-md shadow-sm">
        <div className="flex h-16 items-center justify-between px-3 md:px-8">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            {/* USER PROFILE BOX */}
            <div className="flex items-center gap-3 rounded-2xl bg-gray-50/50 p-1.5 md:pr-4 border border-gray-100 transition-all hover:bg-gray-50">
              ...
              {/* Detail User: Disembunyikan di mobile (hidden), muncul di tablet ke atas (md:flex) */}
              <div className="hidden md:flex flex-col">
                <span className="text-[9px] font-black uppercase tracking-widest text-green-600/70">
                  Authenticated User
                </span>
            ...
            <button
              onClick={this.logout}
              className="group flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white border border-red-100 text-red-500 transition-all hover:bg-red-50 hover:shadow-lg hover:shadow-red-200 active:scale-95"
