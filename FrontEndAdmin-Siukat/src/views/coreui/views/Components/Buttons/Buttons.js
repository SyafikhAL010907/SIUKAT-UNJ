          ...
          <Col xs="12" md="6">
            ...
            <Card>
              ...
              <CardBody className="card-body">
                ...
                <Button color="warning">
                  <i className="fa fa-map-marker"></i>&nbsp; Warning
                </Button>
                <Button color="danger">
            ...
            <Card>
              <CardHeader>
                ...
                <small>
                  Add this <code>disabled="disabled"</code>
                </small>
              </CardHeader>
              <CardBody className="card-body">
            ...
            <Card>
              <CardHeader>
                ...
                <small>
                  Add this class <code>.active</code>
                </small>
              </CardHeader>
              <CardBody className="card-body">
            ...
            <Card>
              <CardHeader>
                ...
                <small>
                  Add this class <code>.btn-block</code>
                </small>
              </CardHeader>
              <CardBody className="card-body">
          ...
          <Col xs="12" md="6">
            ...
            <Card>
              ...
              <CardBody className="card-body">
                ...
                <Button outline color="secondary">
                  <i className="fa fa-lightbulb-o"></i>&nbsp; Secondary
                </Button>
                <Button outline color="success">
                  <i className="fa fa-magic"></i>&nbsp; Success
                </Button>
            ...
            <Card>
              ...
              <CardBody className="card-body">
                <Button outline color="primary" active>
                  Primary
                </Button>
                <Button outline color="secondary" active>
                  Secondary
                </Button>
                <Button outline color="success" active>
                  Success
                </Button>
                <Button outline color="info" active>
                  Info
                </Button>
                <Button outline color="warning" active>
                  Warning
                </Button>
                <Button outline color="danger" active>
                  Danger
                </Button>
              </CardBody>
            </Card>
