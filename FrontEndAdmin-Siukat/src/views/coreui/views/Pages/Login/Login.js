...
class Login extends Component {
  ...
  handleNamaPengguna(e) {
    this.setState({ no_peserta: e.target.value });
  }
  handleKataSandi(e) {
  ...
  render() {
    ...
    if (
      this.state.authCookie &&
      this.state.authCookie !== "undefined" &&
      this.state.authCookie !== "null"
    ) {
    ...
    return (
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #d1fae5 0%, #f0fdf4 50%, #ffffff 100%)",
        }}
      >
        {/* Main Wrapper */}
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm font-bold opacity-90 leading-relaxed px-4 tracking-wide uppercase">
                  Sistem Informasi <span className="text-white">UKT</span>
                  <br />
          ...
          <div className="flex-1 p-10 md:p-16 flex flex-col justify-center bg-white relative">
            ...
            >
              ...
              <div className="flex flex-col space-y-2">
                <label className="text-[11px] font-black text-[#004d23]/50 uppercase tracking-[0.2em] ml-1">
                  Username
                </label>
              ...
              <div className="flex flex-col space-y-3 pt-2">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-1">
                  <span className="text-[11px] font-black uppercase tracking-[0.2em] text-[#004d23]/50 flex items-center">
                    <i className="fa fa-shield mr-2 text-[#059669]"></i>{" "}
                    Verification
                  </span>
                  <div
                  ...
                  >
                    <span>Berapakah</span>
                    <span className="px-3 py-1 bg-white text-[#059669] rounded-lg text-sm">
                      {this.props.captcha.pertanyaan}
                    </span>
                    <span>?</span>
                  </div>
                </div>
              ...
              <div className="pt-6">
                ...
                >
                  <span className="relative z-10 tracking-[0.2em] uppercase text-[12px]">
                    {this.state.tombolMasuk}
                  </span>
