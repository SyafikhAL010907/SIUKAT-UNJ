...
let FormJadwalUkt = (props) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="sm:col-span-2 group">
                            ...
                            <Field name="pengisian" component={InputBs} type="text" placeholder="Contoh: 1 - 10 Maret 2024"
                                className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all shadow-sm group-hover:shadow-md"/>
                        </div>
            ...
            {/* Tombol Simpan Terintegrasi - Pindah ke Bawah Tengah */}
