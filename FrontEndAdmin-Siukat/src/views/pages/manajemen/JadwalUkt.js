                        ...
                        <div className="grid grid-cols-1 gap-4">
                             <div>
                                <div className="flex justify-between items-center mb-1 ml-1">
                                    <label className="block text-xs font-bold uppercase text-emerald-700 m-0">Tanggal Mulai Login</label>
                                    {canEdit && (
                                        <button type="button" onClick={() => props.change("tanggal_mulai", "")} 
                                ...
                                <Field name="tanggal_mulai" component={InputDayPicker} placeholder="Pilih Tanggal Mulai"
                                    disabled={!canEdit}
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-1 ml-1">
                                    <label className="block text-xs font-bold uppercase text-red-700 m-0">Tanggal Selesai Login (Tutup)</label>
                                    {canEdit && (
                                        <button type="button" onClick={() => props.change("tanggal_selesai", "")} 
                                            className="text-[10px] font-bold text-gray-400 hover:text-red-600 transition-colors flex items-center">
                                            <i className="fa fa-refresh mr-1"></i> RESET
                                        </button>
                                    )}
                                </div>
                                <Field name="tanggal_selesai" component={InputDayPicker} placeholder="Pilih Tanggal Selesai"
                                    disabled={!canEdit}
                            ...
                            <div className="pt-2 border-t border-dashed border-gray-200">
                                <div className="flex justify-between items-center mb-1 ml-1">
                                    <label className="block text-xs font-bold text-emerald-600 uppercase m-0">Tanggal Akhir (Masa Perpanjangan)</label>
                                    {canEdit && (
                                        <button type="button" onClick={() => props.change("tanggal_akhir", "")} 
                                            className="text-[10px] font-bold text-gray-400 hover:text-emerald-600 transition-colors flex items-center">
                                            <i className="fa fa-refresh mr-1"></i> RESET
                                        </button>
                                    )}
                                </div>
                                <Field name="tanggal_akhir" component={InputDayPicker} placeholder="Isi untuk masa perpanjangan"
                                    disabled={!canEdit}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="sm:col-span-2 group">
                            <div className="flex items-center space-x-2 mb-1.5 ml-1">
                                ...
                                <label className="block text-xs font-black text-gray-500 uppercase tracking-wide">Periode Pengisian Data</label>
                            </div>
                        ...
                        <div className="sm:col-span-2 group">
                            <div className="flex items-center space-x-2 mb-1.5 ml-1">
                                ...
                                <label className="block text-xs font-black text-gray-500 uppercase tracking-wide">Tanggal Pengumuman UKT</label>
                            </div>
                        ...
                        <div className="group">
                            <div className="flex items-center space-x-2 mb-1.5 ml-1">
                                ...
                                <label className="block text-xs font-black text-gray-500 uppercase tracking-wide">Batas Lapor Diri</label>
                            </div>
                        ...
                        <div className="group">
                            <div className="flex items-center space-x-2 mb-1.5 ml-1">
                                ...
                                <label className="block text-xs font-black text-gray-500 uppercase tracking-wide">Batas Pembayaran</label>
                            </div>
                ...
                <div className="pt-10 flex justify-center border-t border-gray-100">
                    <div className="w-full max-w-md">
                        ...
                        >
                            ...
                            <span className="uppercase tracking-widest">Simpan Perubahan Jadwal</span>
                        </button>
                        <p className="text-center text-[10px] text-gray-400 mt-4 italic">
                            *Perubahan ini akan langsung berdampak pada seluruh akses sistem mahasiswa.
                        </p>
                    </div>
                </div>
            )}
                ...
                <div className="modern-card">
                    ...
                    <div className="glass-header flex flex-col md:flex-row md:items-center justify-between gap-6 border-none rounded-none">
                        <div className="flex items-center space-x-5 text-emerald-900">
                            ...
                            <div>
                                <h2 className="text-2xl font-black tracking-tight">Pengaturan Jadwal UKT</h2>
                                <p className="text-emerald-700/70 text-sm font-medium">Kelola periode pengisian, klarifikasi, dan pembayaran</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-4 bg-white/30 p-2.5 rounded-2xl backdrop-blur-xl border border-white/50 shadow-sm">
                            <span className="text-emerald-900 text-[10px] font-black uppercase ml-2 hidden sm:inline tracking-widest">Pilih Jalur:</span>
                            <select 
