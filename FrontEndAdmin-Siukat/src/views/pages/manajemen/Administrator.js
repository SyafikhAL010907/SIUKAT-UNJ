        ...
        <div className="bg-white rounded-2xl shadow-2xl border-0 flex flex-col w-full outline-none focus:outline-none">
          ...
          <div className="flex items-center justify-between p-5 border-b border-gray-100 rounded-t-2xl bg-emerald-600 text-white">
            <h3 className="text-lg font-bold">
              <i
                className={isEdit ? "fa fa-edit mr-2" : "fa fa-user-plus mr-2"}
              ></i>
...
class Administrator extends React.Component {
  ...
  componentWillMount() {
    ...
    this.props.dispatch(
      admin.fetchAdmin(cookies.get(cookieName), {
        perPage: 10,
        page: 1,
        keyword: "",
      }),
  ...
  handleDelete = (e) => {
    ...
    this.props.dispatch(
      admin.deleteById(
        ...
        this.state.usernameWillBeDeleted,
      ),
    );
  };
            ...
            <div className="relative bg-white rounded-2xl max-w-sm w-full p-6 shadow-2xl animate-fadeIn">
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm mt-2">
                  ...
                  <span className="block font-bold text-gray-800 mt-1 italic">
                    "{this.state.usernameWillBeDeleted}"
                  </span>
                </p>
              </div>
              <div className="flex space-x-3 mt-6">
                <button
                  onClick={this.modalDelete}
                  className="flex-1 py-2.5 font-bold text-gray-500 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all"
                >
                  Batal
                </button>
                <button
                  onClick={this.handleDelete}
                  className="flex-1 py-2.5 font-bold text-white bg-red-600 rounded-xl hover:bg-red-700 shadow-lg shadow-red-100 transition-all"
                >
                  Ya, Hapus
                </button>
              </div>
