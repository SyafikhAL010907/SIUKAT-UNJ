                    ...
                    { (status_kepemilikan === "milik_sendiri" || status_kepemilikan === "bersama_saudara") && (
                        <div>          
                            ...
                            <FormGroup row>
                                ...
                                { (props.initialValues && props.initialValues.scan_pbb !== "" && props.initialValues.scan_pbb !== null) && (
                                    <Col md={4}>
                                        <a href={storage+"/"+props.initialValues.scan_pbb} target="_blank" rel="noopener noreferrer" className="btn btn-success btn-block"><i className="fa fa-file"></i> Lihat PBB</a>
                                    </Col>
                                )}
                            </FormGroup>
                        </div>
                        ...
                        <div>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={4}>
                                    ...
                                    { (props.initialValues && props.initialValues.scan_kontrak !== "" && props.initialValues.scan_kontrak !== null) && (
                                        <a href={storage+"/"+props.initialValues.scan_kontrak} target="_blank" rel="noopener noreferrer" className="btn btn-success btn-block btn-sm"><i className="fa fa-file"></i> Lihat Surat Perjanjian Kontrak</a>
                                    )}
                                </Col>
                            </FormGroup>
                        </div>
                        ...
                        { (this.props.rumah.status_kepemilikan === "milik_sendiri" ||  this.props.rumah.status_kepemilikan === "bersama_saudara") && (
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                    { (this.props.rumah.scan_pbb !== "" && this.props.rumah.scan_pbb !== null) && (
                                        <a href={ storage+"/"+this.props.rumah.scan_pbb } target="_blank" rel="noopener noreferrer">
                                            <Button color="primary" size="sm"><i className="fa fa-download"></i> Lihat PBB</Button>
                                        </a>
                                    )}
                                    </td>
                                </tr>
                        ...
                        { this.props.rumah.status_kepemilikan === "kontrak" && (
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                    { (this.props.rumah.scan_kontrak !== "" && this.props.rumah.scan_kontrak !== null) && (
