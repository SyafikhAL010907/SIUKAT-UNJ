...
export function fetchAdmin(token, pageKeyword) {
  return new Promise((resolve, reject) => {
    axios
      .post(service + "/admin/datatable", pageKeyword, {
        headers: {
...
export function deleteById(token, username) {
  return new Promise((resolve, reject) => {
    axios
      .delete(service + "/admin/delete/" + username, {
        headers: {
          Authorization: "Bearer " + token,
        },
      })
...
export function triggerGlobalTerimaUKT(token, input) {
  return new Promise((resolve, reject) => {
    axios
      .post(service + "/admin/trigger-terima-ukt", input, {
        headers: {
          Authorization: "Bearer " + token,
        },
      })
